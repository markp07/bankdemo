...
INSERT INTO client (id, address, birth_date, first_name, last_name) VALUES (1, "Demo Road 1", "1975-12-25", "Hello", "World");
...
INSERT INTO transaction (id, amount, date, description, type, account_id, contra_account_id) VALUES (1, 125.5, "2019-07-04", "Demo Transaction #2", 1, 1, 3);
INSERT INTO transaction (id, amount, date, description, type, account_id, contra_account_id) VALUES (1, 100.0, "2019-07-07", "Demo Transaction #3", 0, 3, 1);
INSERT INTO transaction (id, amount, date, description, type, account_id, contra_account_id) VALUES (1, 125.5, "2019-07-10", "Demo Transaction #4", 1, 3, 1);